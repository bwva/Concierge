...
#     META_MERGE => { meta-spec=>{ version=>q[2] }, resources=>{ bugtracker=>{ web=>q[https://github.com/bwva/Concierge/issues] }, repository=>{ type=>q[git], url=>q[https://github.com/bwva/Concierge.git], web=>q[https://github.com/bwva/Concierge] } } }
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '         "web" : "https://github.com/bwva/Concierge/issues"' >> META_new.json
	$(NOECHO) $(ECHO) '      },' >> META_new.json
	$(NOECHO) $(ECHO) '      "repository" : {' >> META_new.json
	$(NOECHO) $(ECHO) '         "type" : "git",' >> META_new.json
	$(NOECHO) $(ECHO) '         "url" : "https://github.com/bwva/Concierge.git",' >> META_new.json
